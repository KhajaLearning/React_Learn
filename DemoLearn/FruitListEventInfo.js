...
function FruitListItems(props) {
  return (
    <li key={props.fruit.key} onClick={(e) => removeItem(e, props.fruit.name)}>
      {props.fruit.name}
    </li>
...
function FruitListEventInfo(props) {
...
ReactDOM.createRoot(document.getElementById("root")).render(
  <FruitListEventInfo fruits={data} />
);
